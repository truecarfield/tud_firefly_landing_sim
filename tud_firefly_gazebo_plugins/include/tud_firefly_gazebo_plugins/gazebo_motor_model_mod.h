...
#ifndef ROTORS_GAZEBO_PLUGINS_MOTOR_MODELS_MOD_H
#define ROTORS_GAZEBO_PLUGINS_MOTOR_MODELS_MOD_H
...
class GazeboMotorModelMod : public MotorModel, public ModelPlugin {
 public:
  GazeboMotorModelMod()
      : ModelPlugin(),
        MotorModel(),
...
#endif // ROTORS_GAZEBO_PLUGINS_MOTOR_MODELS_MOD_H
