...
#ifndef ROTORS_GAZEBO_PLUGINS_CONTROLLER_INTERFACE_MOD_H
#define ROTORS_GAZEBO_PLUGINS_CONTROLLER_INTERFACE_MOD_H
...
class GazeboControllerInterfaceMod : public ModelPlugin {
 public:
  GazeboControllerInterfaceMod()
      : ModelPlugin(),
...
#endif // ROTORS_GAZEBO_PLUGINS_CONTROLLER_INTERFACE_MOD_H
