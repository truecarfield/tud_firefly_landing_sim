...
#ifndef ROTORS_GAZEBO_PLUGINS_IMU_MOD_PLUGIN_H
#define ROTORS_GAZEBO_PLUGINS_IMU_MOD_PLUGIN_H
...
class GazeboImuModPlugin : public ModelPlugin {
 public:
...
#endif // ROTORS_GAZEBO_PLUGINS_IMU_MOD_PLUGIN_H
